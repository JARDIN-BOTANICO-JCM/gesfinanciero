 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', dirname(__FILE__).'/../../../../../repo/recursos/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'logo_inst.jpg');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 48);
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Acappdemy PDF Creator');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'GIMNASIO SANTAMARIA DE LA SABANA');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "NIT. 901.018.121-0");
